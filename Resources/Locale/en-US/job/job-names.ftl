...
job-name-intern = medical student
job-name-doctor = medical doctor
job-name-chemist = pharmacist

job-name-technical-assistant = mechanic
...
JobMedicalIntern = medical student
JobMime = mime
...
JobSecurityOfficer = police officer
JobServiceWorker = service worker
JobStationEngineer = engineer
JobTechnicalAssistant = mechnanic
JobWarden = warden
JobBoxer = boxer
